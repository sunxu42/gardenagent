...
from agent.emotion.constants import RELATIONSHIP_STAGE_PRESETS
from agent.emotion.core.affect_lock import (
    AgentVadLock,
    RelationshipLock,
    build_lock_state_payload,
)
from agent.emotion.core.appraisal_utils import sanitize_relationship_deltas
from agent.emotion.core.policy import ResponsePolicy, TurnAppraisalV2
from agent.emotion.core.relationship import (
    RelationshipState,
...
from agent.emotion.core.update import apply_appraisal, decay_over_time
from agent.emotion.core.vad import EMOTION_PROTOTYPES, VAD, project
from agent.emotion.synthesis.mood_synthesizer import SynthesisResult, synthesize_response
