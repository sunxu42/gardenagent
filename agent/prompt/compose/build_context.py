"""Build per-turn PromptContext from ModelRequest + EmotionService."""
...
from agent.prompt.turn_plan.planner import DanhuangReplyPlanner
...
class PromptContextBuilder:
    ...
    def build(self, request: ModelRequest) -> PromptContext:
        ...
        ctx = PromptContext(
            ...
            user_text=last_human_text(request.state.get("messages") or []),
        )
