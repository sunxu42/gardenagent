...
from agent.prompt.conditions import evaluate_when
from agent.prompt.context import PromptContext
from agent.prompt.formatting import format_slice_value
from agent.prompt.modules import TIER_ORDER, PromptModule
from agent.prompt.renderers import RendererDeps, get_renderer, validate_manifest_renderers
from agent.prompt.slice import interpolate_template, load_yaml_source, resolve_slice
