...
class Mem0SummarizationFlushMiddleware(AgentMiddleware):
    ...
    async def _flush_after_summarization(self) -> None:
        from yard.memory.runtime.flush import flush_agent_session_memory
    ...
    def wrap_model_call(
        ...
        # YardManager 走异步 agent 路径；同步路径不触发 flush，避免嵌套 event loop。
